    ...
    res.json({
      ...
      data: {
        ...
        flags: {
          ...
          canReadHall: req.ability.can("read", "Hall") || req.ability.can("manage", "all"),
          canCreateHall: req.ability.can("create", "Hall") || req.ability.can("manage", "all"),
          canUpdateHall: req.ability.can("update", "Hall") || req.ability.can("manage", "all"),
          canDeleteHall: req.ability.can("delete", "Hall") || req.ability.can("manage", "all"),
          canReadHallBooking: req.ability.can("read", "HallBooking") || req.ability.can("manage", "all"),
          canUpdateHallBooking: req.ability.can("update", "HallBooking") || req.ability.can("manage", "all"),
          canDeleteHallBooking: req.ability.can("delete", "HallBooking") || req.ability.can("manage", "all"),
