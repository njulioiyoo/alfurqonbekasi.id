...
function get_azan_time(selectObject) {
   ...
   var value = selectObject.value;  
	var azan_time_json_url = "http://api.aladhan.com/v1/timingsByCity?city="+ value +"&country="+ value +"&method=8"; // Thanks to API Aladhan.com
	var namaz_time_json_url = "http://api.aladhan.com/v1/timingsByCity?city="+ value +"&country="+ value +"&method=8&tune=2,10,10,10,10,10,10,10,10";
